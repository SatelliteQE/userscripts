...
const reviewers = {
    'airgun': {
        'tier1': ['eko999', 'latran', 'mshriver', 'vijay8451'],
        'tier2': ['lhellebr', 'jyejare', 'mirekdlugosz', 'omkarkhatavkar']
    },
    'automation-tools': {
        'tier1': ['JacobCallahan', 'vijay8451'],
        'tier2': ['jyejare', 'lpramuk', 'mirekdlugosz', 'rplevka']
    },
    'nailgun': {
        'tier1': ['lhellebr', 'mshriver', 'omkarkhatavkar', 'rplevka'],
        'tier2': ['JacobCallahan', 'jyejare', 'mirekdlugosz']
    },
    'robottelo': {
        'tier1': ['eko999', 'jameerpathan111', 'latran', 'lhellebr', 'mshriver', 'omkarkhatavkar', 'swadeley', 'vijay8451'],
        'tier2': ['JacobCallahan', 'jyejare', 'lpramuk', 'mirekdlugosz', 'pondrejk', 'rplevka']
    },
    'robottelo-ci': {
        'tier1': ['JacobCallahan', 'rplevka'],
        'tier2': ['jyejare', 'lpramuk', 'mirekdlugosz']
    },
    'satellite6-upgrade': {
        'tier1': ['devendra104'],
        'tier2': ['jyejare', 'mirekdlugosz']
    },
    'testfm': {
